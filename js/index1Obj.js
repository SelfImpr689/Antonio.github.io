...
//	首页对象初始化
	...
	getGroupList:function(userID,shouldEmpty){
		//$('.mop-load-0').show();
		//indexObj.mopload();
		var url = '120.26.61.199/survivor/rest/ControlService/getPicDatas/'+userID+'?pageNum='+index1Obj.pageNum;
		$.ajax({
			type:"get",
			url:url,
			async:true,
   ...
   //进入主页
	...
	go2FriendPage: function(navID){
		window.location.href="120.26.61.199/survivor/pn?id="+navID;
	},
	...
	uploadGroup:function(){
		...
		window.location.href="120.26.61.199/survivor/upload";
	},
...
var loginObj = {
	...
	getUser: function(){
		$.ajax({
			type:"get",
			url:"120.26.61.199/survivor/rest/UserService/getCurrentUser",
			async:true,
			dataType:'json',
			success: function(data){
			  if(data.message==-1){
	...
	logout:function(){
		$.ajax({
			type:"get",
			url:"120.26.61.199/survivor/rest/UserService/logout",
			async:true,
			dataType:'json',
			success: function(data){
    ...
    submitForm:function(){
        $("#login-form-submit").on("click",function(){
            ...
            loginObj.submitOption = {
                type:"POST",
                url:"120.26.61.199/survivor/rest/UserService/login",
                async:true,
                data:{
                	userName: userName,
    ...
    submitForm:function(){
        $("#register-user-form-submit").on("click",function(){
            ...
            registerGroup.submitOption = {
                type:"POST",
                url:"120.26.61.199/survivor/rest/UserService/createUser",
                dataType:'json',
